# Contributing to Occupation Ontology

The following is a set of guidelines for contributing to OccO. 
...
Please use our [Issue Tracker](https://github.com/Occupation-Ontology/OccO/issues/) for reporting problems with the ontology. 
...
either as a primary term or a synonym term. You can search for your term using [Ontobee](https://ontobee.org) or [OLS](http://www.ebi.ac.uk/ols/ontologies/OccO).
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/Occupation-Ontology/OccO/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/Occupation-Ontology/OccO/issues/new/choose).
